...
export default function PrivacyPage() {
  ...
  return (
    <main style={wrapStyle}>
      <h2 className="font-bebas text-4xl text-center">
      ...
      <section className={sectionClasses}>
        ...
        <p>
          ...
          <strong>{c.controller.name}</strong>
          {c.controller.address ? (
            <> (adresse : {c.controller.address})</>
          ) : null}
      ...
      <section className={sectionClasses}>
        ...
        <ul style={{ paddingLeft: 18 }}>
          <li>
            Identité et contact (nom, prénom, email) pour les formulaires.
          </li>
          <li>
            Données de compte (identifiants, historique de sessions de
            démonstration).
          </li>
          <li>
            Éléments liés aux commandes de billets <em>fictives</em> (dates,
            nombres de billets).
          </li>
          <li>Données techniques (adresse IP, logs techniques, navigateur).</li>
          <li>
            Cookies/traceurs nécessaires au fonctionnement et, avec
      ...
      <section className={sectionClasses}>
        ...
        <ul style={{ paddingLeft: 18 }}>
          <li>
            Gestion des comptes et démonstrations (intérêt légitime
            pédagogique).
          </li>
          <li>
      ...
      <section className={sectionClasses}>
        ...
        <p>
          Les données sont conservées pour la durée strictement nécessaire puis
      ...
      <section className={sectionClasses}>
        ...
        <p>
          Les données sont accessibles aux membres habilités. Elles sont
          hébergées par <strong>{c.hosting.name}</strong> ({c.hosting.country}).
        </p>
      </section>
      ...
      <section className={sectionClasses}>
        ...
        {c.dataTransfersOutsideEU ? (
          <p>
            Des transferts peuvent intervenir hors UE avec garanties
            appropriées. Détails sur demande à{" "}
            <a href={`mailto:${c.contactEmail}`}>{c.contactEmail}</a>.
          </p>
        ) : (
      ...
      <section className={sectionClasses}>
        ...
        <p>
          ...
          {c.analytics.tool ? (
            <>
              {" "}
              via <em>{c.analytics.tool}</em>
            </>
          ) : null}
          {c.analytics.ipAnonymized ? ", avec anonymisation de l’IP." : "."}{" "}
      ...
      <section className={sectionClasses}>
        ...
        <p>
          ...
          portabilité. Contact :{" "}
          <a href={`mailto:${c.contactEmail}`}>{c.contactEmail}</a>. Réclamation
      ...
      <section className={sectionClasses}>
        ...
        <p>
          Utilisation encadrée par l’établissement scolaire. Consentement
          parental si nécessaire.
        </p>
      </section>
      ...
      <section className={sectionClasses}>
        ...
        <p>
          Mesures techniques/organisationnelles raisonnables (chiffrement en
          transit, journalisation, principes de moindre privilège).
        </p>
      </section>
      ...
      <section className={sectionClasses}>
        ...
        <p>
          Politique susceptible d’évoluer. La date de « Dernière mise à jour »
          fait foi. En cas de changement important, une info pourra être
